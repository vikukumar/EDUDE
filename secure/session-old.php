   ...
   if($stmt = mysqli_prepare($db, $sql)){  
                   ...
                   if(mysqli_stmt_execute($stmt)){
                      ...
                      if(!(mysqli_stmt_num_rows($stmt) == 1)){   
                                ...
                                $sql = "INSERT INTO edu_college values(".$cid.",'".$cname."','".$cemail."',NULL,NULL,NULL,".$ccode.",'".$hpwd."','".$cuniv."',".$cnumber.",'".$caddress."','assest/img/ogimg.png','edu_".$ccode."_','".$path."',DEFAULT);";
...
function del_class($db, $classcode){
    ...
    $sql = "DROP Table edu_".$classcode."_routine;";
    $res = mysqli_query($db, $sql);
    $sql = "DROP Table edu_".$classcode."_students;";
    $res = mysqli_query($db, $sql);
    if($res){
...
function profile($data){
    $data = "<div class='fluid-container pro'>
                 ...
                 <div class='fluid-container pro-card'>
                          <img src='assest/img/ico/ppdp.png'>
                          <form>
